...
class PhysicalResourceProvider implements ResourceProvider {
  ...
  PhysicalResourceProvider({String? stateLocation, this.logger})
  ...
  Folder? getStateLocation(String pluginId) {
    logger?.fine("getStateLocation $pluginId");
